...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        {
            var consoleAndAngularClientRootUrl = configurationSection["Snooker_App:RootUrl"]?.TrimEnd('/');
            await CreateApplicationAsync(
        ...
        var blazorServerTieredClientId = configurationSection["Snooker_BlazorServerTiered:ClientId"];
        if (!blazorServerTieredClientId.IsNullOrWhiteSpace())
        {
            var blazorServerTieredRootUrl = configurationSection["Snooker_BlazorServerTiered:RootUrl"].EnsureEndsWith('/');
