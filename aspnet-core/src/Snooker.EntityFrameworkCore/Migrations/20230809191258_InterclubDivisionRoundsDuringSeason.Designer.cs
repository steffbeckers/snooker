...
namespace Snooker.EntityFrameworkCore.Migrations
{
    ...
    [Migration("20230809191258_InterclubDivisionRoundsDuringSeason")]
    partial class InterclubDivisionRoundsDuringSeason
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Snooker.Interclub.Clubs.Club", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("InterclubClubs", (string)null);
                });

            modelBuilder.Entity("Snooker.Interclub.Divisions.Division", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int?>("RoundsDuringSeason")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(2);
            ...
            modelBuilder.Entity("Snooker.Interclub.Frames.Frame", b =>
                {
                    ...
                    b.ToTable("InterclubFrames", (string)null);
                });
            ...
            modelBuilder.Entity("Snooker.Interclub.Matches.Match", b =>
                {
                    ...
                    b.ToTable("InterclubMatches", (string)null);
                });
            ...
            modelBuilder.Entity("Snooker.Interclub.Players.Player", b =>
                {
                    ...
                    b.ToTable("InterclubPlayers", (string)null);
                });

            modelBuilder.Entity("Snooker.Interclub.Seasons.Season", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("InterclubSeasons", (string)null);
                });

            modelBuilder.Entity("Snooker.Interclub.Teams.Team", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("InterclubTeams", (string)null);
                });

            modelBuilder.Entity("Snooker.Interclub.Teams.TeamPlayer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("InterclubTeamPlayers", (string)null);
                });
            ...
            modelBuilder.Entity("Snooker.Interclub.Clubs.Club", b =>
                {
                    b.OwnsOne("Snooker.Interclub.Addresses.Address", "Address", b1 =>
                        {
                            ...
                            b1.ToTable("InterclubClubAddresses", (string)null);
            ...
            modelBuilder.Entity("Snooker.Interclub.Divisions.Division", b =>
                {
                    b.HasOne("Snooker.Interclub.Seasons.Season", "Season")
                        .WithMany("Divisions")
            ...
            modelBuilder.Entity("Snooker.Interclub.Players.Player", b =>
                {
                    b.HasOne("Snooker.Interclub.Clubs.Club", "Club")
                        .WithMany("Players")
                        .HasForeignKey("ClubId");
            ...
            modelBuilder.Entity("Snooker.Interclub.Teams.TeamPlayer", b =>
                {
                    ...
                    b.HasOne("Snooker.Interclub.Teams.Team", "Team")
                        .WithMany("Players")
