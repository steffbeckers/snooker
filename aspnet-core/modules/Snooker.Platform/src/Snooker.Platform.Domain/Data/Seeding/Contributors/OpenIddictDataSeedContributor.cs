...
namespace Snooker.Platform.Data.Seeding.Contributors;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        if (!webClientId.IsNullOrWhiteSpace())
        {
            ...
            await CreateApplicationAsync(
                ...
                secret: configurationSection["Snooker_Web:ClientSecret"] ?? "1q2w3e*",
        ...
        {
            string? consoleAndAngularClientRootUrl = configurationSection["Snooker_App:RootUrl"]?.TrimEnd('/');
            await CreateApplicationAsync(
        ...
        string? blazorServerTieredClientId = configurationSection["Snooker_BlazorServerTiered:ClientId"];
        if (!blazorServerTieredClientId.IsNullOrWhiteSpace())
        {
            string blazorServerTieredRootUrl = configurationSection["Snooker_BlazorServerTiered:RootUrl"].EnsureEndsWith('/');
            ...
            await CreateApplicationAsync(
                ...
                secret: configurationSection["Snooker_BlazorServerTiered:ClientSecret"] ?? "1q2w3e*",
                grantTypes: new List<string> //Hybrid flow
                {
                    OpenIddictConstants.GrantTypes.AuthorizationCode,
                    OpenIddictConstants.GrantTypes.Implicit
    ...
    {
        if (await _scopeManager.FindByNameAsync("Snooker") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor
            {
                Name = "Snooker",
                DisplayName = "Snooker API",
                Resources =
                {
                    "Snooker"
                }
